...
public class NavigationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String path = "/viewAllPhonesServlet";
		if (act.equals("delete")) {
			try {
				Integer phoneId = Integer.parseInt(request.getParameter("id"));
				CellPhones phoneToDelete = dao.searchForPhoneById(phoneId);
				dao.deletePhone(phoneToDelete);
			...
			try {
				...
				CellPhones phoneToEdit = dao.searchForPhoneById(tempId);
